...
/// <summary>
/// Summary description for PartywiseOutstanding
/// </summary>
public class PartywiseOutstanding
{
    [Required]
...
public class PartywiseOutstandingDetails
{
    public string result { get; set; }
    public string message { get; set; }
    public string servertime { get; set; }
    public List<DetailsTemplatePartyWiseOutstanding> data { get; set; }
}

public class DetailsTemplatePartyWiseOutstanding
{
