...
/// <summary>
/// Summary description for AutoWorldCup2
/// </summary>
namespace Goldmedal.Emails.App_Code.BLL.Common.Message
{
    public class AutoWorldCup2 : ITask
    {
        ...
        public void Execute(XmlNode node)
        {
            ...
            {
                DataTable dt = da.GetspfireDetails("autosmswordcup2");
                if (dt.Rows.Count == 0)
                {

                    //  if (DateTime.Compare(DateTime.Now, time1) > 0)

                    DataTable dt1 = _messageService.return_dt("autosmswordcup2");
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dt1.Rows.Count; i++)
                        {
                            ...
                            {
                                sms = "Dear "+ dt1.Rows[i]["name"].ToString() + ", Last few days to predict the winners of the matches to be played in the World Cup till the finals. We have checked from our records that you have partially filled the prediction i.e Semi Final and Finals still need to be filled from your end. So do hurry and get the maximum benefit by completing the prediction.There will be no selection allowed post 29th May 2019. Please ignore if you have filled the selection of the winners list.  Regards,  Team Goldmedal  *TC Apply";
                        ...
                        da.CreateSPFireDetails("autosmswordcup2");
                    }
