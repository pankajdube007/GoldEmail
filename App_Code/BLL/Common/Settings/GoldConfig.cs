...
namespace Goldmedal.Emails.App_Code.BLL.Common.Settings
{
    /// <summary>
    /// Summary description for GoldConfig
    /// 
    /// </summary>
    public partial class GoldConfig : IConfigurationSectionHandler
    {
        #region Fields
        ...
        public static void Init()
        {
            if (!_initialized)
            {
                ConfigurationManager.GetSection("GoldConfig");
                _initialized = true;
            }
        }
        #endregion
