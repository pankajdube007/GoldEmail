...
/// <summary>
/// Summary description for NotificationtestDhanbarseController
/// </summary>
public class NotificationtestDhanbarseController : ApiController
{
    [HttpPost]
    [ValidateModel]
    [Route("api/NotificationTestDhanbarse")]
        ...
        try
        {
            ...
            if (mailsms.pooswooshid != "")
            {
                ...
                var task = System.Threading.Tasks.Task.Factory.StartNew
                    (
                    async () => await client.SendMessageAsyncDhanbarse(message)
                    );
