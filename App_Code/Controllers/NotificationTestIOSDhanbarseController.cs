...
/// <summary>
/// Summary description for NotificationTestIOSDhanbarseController
/// </summary>
public class NotificationTestIOSDhanbarseController : ApiController
{
    [HttpPost]
    [ValidateModel]
    [Route("api/NotificationTestIOSDhanbarse")]
    ...
    private string SendPushNotification(notifactiontest mailsms)
    {
        try
        {
            ...
            //Get Certificate
            var appleCert = System.IO.File.ReadAllBytes(HttpContext.Current.Server.MapPath("~/App_Data/UserFiles/APN_Development_D.p12"));
            ...
            //      var redirectToScreen = mailsms.redirectToActivity;
            //      var client = new FCMClient();
            //      var iosnoti = new IOSNotification();
            //      var data = new Dictionary<string, string>();
            //      // var redirectToActivitydata = new Dictionary<string, string>();
            ...
            //   payload.Add("Title", mailsms.title);
            ...
            //      iosnoti.Title = mailsms.title;
            //      iosnoti.Body = mailsms.body;
            //      iosnoti.Sound = "default";
            //      iosnoti.ClickAction = "CustomNotification";
