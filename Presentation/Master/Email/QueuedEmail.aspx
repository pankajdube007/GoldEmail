<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="QueuedEmail.aspx.cs" Inherits="Presentation_Master_Email_QueuedEmail" %>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body table-responsive" style="height: 750px">
                                                                ...
                                                                <div class="col-xs-4">
                                                                    <asp:Button ID="btndeleteall" OnClientClick="javascript:return confirm('Do you really want to delete?');'yes,no';" CssClass="btn-success" runat="server" Text="Delete All Queue Email" OnClick="btndeleteall_Click">
                                                                                ...
                                                                                <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Delete" ReadOnly="True" Width="100px"
                                                                                    ...
                                                                                    <DataItemTemplate>
                                                                                        <asp:LinkButton ID="CmdEdit" EnableViewState="false" runat="server"
                                                                                            CommandArgument='<%# Eval("QueuedEmailID") %>' OnCommand="CmdDelete_Command" OnClientClick="javascript:return DeleteItem();"
