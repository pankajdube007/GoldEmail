...
public partial class Presentation_Master_Email_QueuedMessage : System.Web.UI.Page
{
    ...
    public Presentation_Master_Email_QueuedMessage()
    {
    ...
    protected void CmdDelete_Command(object sender, System.Web.UI.WebControls.CommandEventArgs e)
    {
        ...
        try
        {
            ...
            da.DeleteQueuedMessageByID(FieldTripID);
            ASPxGridView1.DataBind();
        }
        catch (Exception ex)
        {
