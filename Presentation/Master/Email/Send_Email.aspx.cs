...
public partial class Presentation_Master_Email_Send_Email : System.Web.UI.Page
{
    ...
    public Presentation_Master_Email_Send_Email()
    {
    ...
    protected void CmdDelete_Command(object sender, System.Web.UI.WebControls.CommandEventArgs e)
    {
        ...
        try
        {
          ...
          DataTable dt1=  da.GetSendEmailByID(FieldTripID);

            if(dt1.Rows.Count>0)
            {
                txtEmailBody.Html = dt1.Rows[0]["Body"].ToString();
    ...
    protected DataTable GetDataTable()
    {
        ...
        return da.GetSendEmail(fromdate4, todate4);
    }
