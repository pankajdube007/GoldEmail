<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Send_Email.aspx.cs" Inherits="Presentation_Master_Email_Send_Email" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                <ContentTemplate>
                    <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true" SettingsBehavior-AllowGroup="true" OnDataBinding="ASPxGridView1_DataBinding" SettingsBehavior-AllowSort="true" ID="ASPxGridView1" runat="server" align="left"
                        ...
                        KeyFieldName="QueuedEmailID" Width="100%" EnableTheming="True" Theme="Office2010Black">
                        <TotalSummary>
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Module" FieldName="Perpose" Width="100px"
                            ...
                            <dx:GridViewDataTextColumn Caption="Email" FieldName="To" Width="100px"
                            ...
                            <dx:GridViewDataTextColumn Caption="Subject" FieldName="Subject" Width="100px" PropertiesTextEdit-EncodeHtml="true"
                            ...
                            <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View Full Email" ReadOnly="True" Width="100px"
                                VisibleIndex="10">
                                <Settings AllowDragDrop="True" />
                                <DataItemTemplate>
                                    <asp:LinkButton ID="CmdEdit" EnableViewState="false" runat="server"
                                        CommandArgument='<%# Eval("QueuedEmailID") %>' OnCommand="CmdDelete_Command"
                                        Text='Email Text'></asp:LinkButton>
                                </DataItemTemplate>
                        ...
                        <SettingsPager>
                            <PageSizeItemSettings Items="20, 50, 100, 500" Visible="True">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <dx:ASPxPopupControl runat="server" CloseAction="CloseButton" Modal="true" AllowDragging="True" ID="ASPxPopupControl1" Theme="Metropolis" PopupElementID="CmdSubmit" ClientInstanceName="popup" Width="800px" Height="850px" PopupHorizontalAlign="WindowCenter"
                PopupVerticalAlign="WindowCenter" HeaderText="Email Body">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <dx:ASPxHtmlEditor ID="txtEmailBody" runat="server" Height="400px"></dx:ASPxHtmlEditor>
